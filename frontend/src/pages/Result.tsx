          ...
          <div className="flex items-center gap-2 mb-8 bg-white/5 p-1.5 rounded-2xl border border-white/5 self-start overflow-x-auto overflow-y-hidden no-scrollbar max-w-full">
            {tabs.map(tab => (
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-bold transition-all whitespace-nowrap ${filter === tab.id
                ...
                filteredExperiments.map((exp) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="h-px bg-white/5 md:ml-16" />
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 md:ml-16">
                        <div className="flex-1 max-w-xs space-y-2">
                          ...
                          <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                            <div
                              className={`h-full transition-all duration-500 ${exp.status === 'active' ? 'bg-[#10b981]' :
